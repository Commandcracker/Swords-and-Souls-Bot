...
"""
TODO: Make separate Github repo
TODO: Error handling
TODO: fix Key Release
TODO: allow for multiple windows
TODO: allow sending keys to desktop as a separate function
TODO: add documentation
TODO: what is xcomposite
"""
...
class Window(object):
    ...
    def get_name(self) -> str:
        return get_window_property(self.XID, "_NET_WM_NAME", c_char * 1024).decode('utf-8')
    ...
    def get_image(self, geometry: tuple = None) -> np.ndarray:
        if geometry is None:
        ...
        data = np.array(Image(data, geometry[2], geometry[3]))
...
def main():
    ...
    print("Active window xid: {}".format(window.XID))
    print("PID: {}".format(window.get_pid()))
    ...
    while True:
        ...
        if window.is_active:
            ...
            window.send_mouse_click(x, y, ButtonCodes.Button1)
        ...
        print("FPS: {}".format(1 / (time.time() - last_time)), end="\r")
